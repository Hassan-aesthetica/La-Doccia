...
- **Duschkonzepte: KOMPLETT GEPARKT** (Vorgabe Sept. 2026): Alle Duschkonzept-Inhalte sind von der Seite entfernt — Designlinien-Sektion, Beratungs-/Terminformular, Referenzen-Zähler („400+ Projekte"), Editorial-Band, Navigations- und Footer-Links, SEO-Text. Der Shop (inkl. Zubehör, früher „Duschzubehör") bleibt. Wenn Duschkonzepte zurückkommen sollen: Git-History vor Commit „Duschkonzepte raus" hat alle Sektionen.
- **Glas-Lieferanten-Link** (kommt per WhatsApp): wartet — relevant erst, wenn Duschkonzepte zurückkommen.
...
- **Damen- & Sportwelt**: AKTIV — „Damen" in der Navigation führt auf eine eigene kuratierte Welt-Seite (Hero mit Model, Rails: Sport / Jacken & Hüte / Düfte & Pflege / Schmuck). Neue Sport-Unterkategorie in Mode (p102–p106: Leggings, Bra, Biker-Shorts, Zip-Jacke, Trainings-Top, je mit Packshot + Model-Foto). „Sea Breeze" (p01) wurde aus dem Sortiment genommen.
- **Galerien-Regel**: Kein Produktbild darf andere Produkte/Varianten zeigen — das Luxus-Trio-Gruppenfoto wurde deshalb aus den Galerien von Notte/Marmo/Prisma entfernt (jetzt je ein eigenes Solo-Szenenbild). Schmuck p72/p74/p76 und Sonnenhut p88 haben jetzt Trage-Fotos; übrige Einzelbild-Produkte (p73, p75, p77–p81, p89–p96, p100, p101) brauchen bei Gelegenheit weitere Perspektiven.
- **Kinder-Kategorie**: AKTIV — sechs Kinderartikel (Regenjacke, Gummistiefel, Schlappen, Sneaker, Sommerhut in Mode; Kinder-Shampoo in Kosmetik) mit `who:'kinder'`; der Kinder-Filter ist strikt (zeigt nur Kinderartikel), Herren bleibt „in Bearbeitung“.
...
und `_c`-Szene aus dem Drive-Katalog; personenbezogene Artikel (Parfüm, Handtücher,
Morgenmäntel, Taschen, Handcreme, Hausschuhe) tragen zusätzlich ein KI-Kampagnenbild
mit Person (assets/e/). Die Hausschuhe (p47) wurden neu gestaltet
(assets/p/47_hausschuhe_neu_*.jpg) — die alten Drive-Dateien 47_* bleiben ungenutzt liegen.
